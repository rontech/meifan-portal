...
object HaircutPrice extends ModelCompanion[HaircutPrice, ObjectId] {
    def collection = MongoConnection()(
    current.configuration.getString("mongodb.default.db")
      .getOrElse(throw new PlayException(
        "Configuration error",
        "Could not find mongodb.default.db in settings")))("HaircutPrice")
        
        val dao = new SalatDAO[HaircutPrice, ObjectId](collection) {}
}
