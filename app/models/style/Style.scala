 ...
 * @param styleDiameter
 * @param faceShape
 * @param consumerAgeGroup
 * @param consumerSex
 * @param consumerSocialStatus
 * @param stylePicDescription 发型图片描述（用于发型展示）
 */
