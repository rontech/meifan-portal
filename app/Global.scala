   ...
   if(User.findAll.isEmpty){
    ...
    if(Blog.findAll.isEmpty){
      Seq(
        ...
        Blog(new ObjectId("532a8ef4a89ee221d679bdc4"),"4444","2", "zhenglu6", new Date(), new Date(), "分类1", None,List("2222"), true, None,false,true),
        Blog(new ObjectId("53195fb4a89e175858abce90"),"test01","test3333333333333333333333333333333333333333333333", "zhenglu", new Date(), new Date(), "分类2", None, List("111", "2222"),true,None,false,true),
        Blog(new ObjectId("53195fb4a89e175858abce91"),"test02","test2222222222222222222222222222222222222222222222", "zhenglu316", new Date(), new Date(), "分类1", None,List("2222"), true, None,false,true)
    	).foreach(Blog.save)
    }
