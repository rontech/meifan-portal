  ...
  def insertMaster() = {
   ...
   if(Province.findAll.isEmpty) {
    ...
    if(Region.findAll.isEmpty) {
      Seq(
          Region(new ObjectId("5317c0d1d4d57997ce3e6dda"), "Xuan", "Shandong"),
