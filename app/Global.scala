   ...
   if(Stylist.findAll.isEmpty) { 
    ...
    if(Style.findAll.isEmpty) { 
      Seq(
        ...
        Style(new ObjectId("530d828cd7f2861457771c0c"), "六道仙人发型", new ObjectId("530d8010d7f2861457771bf6"), List(new OnUsePicture(new ObjectId, "main", Some(1), None)),"自然",List("Supple"),"长",List("红","黑色"),List("少","多","一般"),List("软","硬"),List("适中","细"),List("标准","四角"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("1-10","11-20"),"男",List("程序员"),date("2014-03-12"),true),
