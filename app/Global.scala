    ...
    if(Comment.findAll.isEmpty){
      Seq (
       Comment(new ObjectId("53195fb4a89e175858abce85"), 2, new ObjectId("5317c0d1d4d57997ce3e6d6a"), "布置的很精致，温馨。价格很适中，好地方，强力推荐", "demo07", date("2014-02-18"), true),
        ...
        Comment(new ObjectId, 2, new ObjectId("5317c0d1d4d57997ce3e6d6b"), "环境优雅，服务态度好。最重要的是发型师的技术非常不错。非常满意，下次还会来的。", "demo07", date("2014-03-31"), true),
        Comment(new ObjectId, 2, new ObjectId("5317c0d1d4d57997ce3e6d6b"), "这家店是我有史以来去过的最好的一家店，强力推荐大家一起去。", "demo07", date("2014-04-01"), true)
