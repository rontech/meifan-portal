...
object InitialData {
  ...
  def insert() = {
    ...
    if(Salon.findAll == Nil) { 
      ...
      Seq(
        Style(new ObjectId("530d828cd7f2861457771c0b"), "四代火影发型式", new ObjectId("530d7288d7f2861457771bdd"), new ObjectId("530d8010d7f2861457771bf8"), List("B002740532_164-219.jpg","B004689277_164-219.jpg","B004538417_164-219.jpg"),"清爽、舒适","烫发","中",List("黄色","绿色","紫色"),List("很少","很多","较少"),List("软","硬"),List("国字","方形","圆形","尖"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生"),
        Style(new ObjectId("530d828cd7f2861457771c0c"), "六道仙人发型", new ObjectId("530d7288d7f2861457771bdd"), new ObjectId("530d8010d7f2861457771bf8"), List("B004670057_164-219.jpg","B004670057_164-219.jpg","B004554657_164-219.jpg"),"舒适","染发","长",List("绿色","紫色"),List("很少","很多","较少"),List("软","硬"),List("国字","方形","圆形","尖"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生"),
        Style(new ObjectId("530d828cd7f2861457771c0d"), "海贼王发型", new ObjectId("530d7292d7f2861457771bde"), new ObjectId("530d8010d7f2861457771bfd"), List("B004554657_164-219.jpg"),"清爽、舒适","烫发","中",List("黄色","绿色","紫色"),List("很少","很多","较少"),List("软","硬"),List("国字","方形","圆形","尖"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生")
      ).foreach(Style.save)
