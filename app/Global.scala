   ...
   if(User.findAll.isEmpty){
    ...
    if(Style.findAll.isEmpty) { 
      Seq(
        ...
        Style(new ObjectId("530d828cd7f2861457772c0c"), "干练超短发", new ObjectId("53202c29d4d5e3cd47efffd9"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"gorgeous",List("Supple"),"super-short",List("black","chocolate","brown"),List("much","moderate","few"),List("greasy","general"),List("moderate","thin"),List("long-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--twenty-five","twenty-five--thirty-five"),"female",List("star"),date("2014-03-12"),true),
        Style(new ObjectId("530d828cd7f2861457771c0d"), "知性超短发", new ObjectId("53202c29d4d5e3cd47efffd6"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"fresh",List("Supple"),"super-short",List("black","chocolate","brown"),List("much","moderate","few"),List("greasy","general"),List("bold","thin"),List("long-face","round-face","oval-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--fifteen","fifty-five--","one--twenty-five","twenty-five--thirty-five"),"female",List("star"),date("2014-03-12"),true),
        Style(new ObjectId("533133f29aa6b4dfc54a02ed"), "甜美超短发", new ObjectId("53202c29d4d5e3cd47efffd4"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"fresh",List("Supple","Perm"),"super-short",List("flax","red","alternative"),List("much","moderate","few"),List("silky","greasy","general"),List("bold"),List("long-face","round-face","oval-face","diamond-face"),"凌乱中带有一丝淡淡的忧伤！",List("one--fifteen","fifty-five--","one--twenty-five","twenty-five--thirty-five"),"female",List("star","evening-wear","others"),date("2014-03-12"),true),
        Style(new ObjectId("533134b69aa6b4dfc54a02ee"), "妩媚超短发", new ObjectId("53202c29d4d5e3cd47effff2"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"fresh",List("Supple","Perm"),"super-short",List("flax","red","alternative"),List("much","moderate","few"),List("silky","greasy","general"),List("bold","thin","moderate"),List("long-face","oval-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--fifteen","fifty-five--","one--twenty-five","twenty-five--thirty-five"),"female",List("star","evening-wear","others"),date("2014-03-12"),true),
        ...
        Style(new ObjectId("533151209aa6b4dfc54a0374"), "知书内扣短发", new ObjectId("53202c29d4d5e3cd47effff2"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"sweet",List("Supple","Perm"),"short",List("black","chocolate"),List("much","moderate","few"),List("silky","greasy","general"),List("bold"),List("long-face","round-face","oval-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--fifteen","fifty-five--","one--twenty-five","twenty-five--thirty-five"),"female",List("star","street","evening-wear"),date("2014-03-12"),true),
        ...
        //女长
        Style(new ObjectId("533151209aa6b4dfc54a0478"), "波浪长发", new ObjectId("53202c29d4d5e3cd47efffd9"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"personality",List("Supple","Perm"),"long",List("chocolate","brown","flax","red"),List("much"),List("silky","greasy","general"),List("bold","thin","moderate"),List("round-face","oval-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--twenty-five","twenty-five--thirty-five"),"female",List("star","street","evening-wear"),date("2014-03-12"),true),
        Style(new ObjectId("533151209aa6b4dfc54a0479"), "可爱梨花头", new ObjectId("53202c29d4d5e3cd47efffd6"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"natural",List("Supple"),"long",List("chocolate","brown","flax","red"),List("much"),List("silky","greasy","general"),List("bold"),List("oval-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--twenty-five","twenty-five--thirty-five"),"female",List("star","evening-wear","others"),date("2014-03-12"),true),
        Style(new ObjectId("533151209aa6b4dfc54a0473"), "妩媚大长发", new ObjectId("53202c29d4d5e3cd47efffd5"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"personality",List("Supple","Perm"),"long",List("chocolate","brown","flax","red"),List("much"),List("silky","greasy","general"),List("bold"),List("long-face","round-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--twenty-five","twenty-five--thirty-five"),"female",List("star"),date("2014-03-12"),true),
        Style(new ObjectId("530d828cd7f2861457761e0b"), "过肩大长发", new ObjectId("530d8010d7f2861457771bf8"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"fresh",List("Supple"),"long",List("black","chocolate","brown","flax","red","alternative"),List("much","moderate","few"),List("greasy","general"),List("bold","thin"),List("round-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--twenty-five","twenty-five--thirty-five"),"female",List("star"),date("2014-03-12"),true),
        Style(new ObjectId("530d828cd7f2861457762e0c"), "过肩长卷发", new ObjectId("53202c29d4d5e3cd47effff2"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"gorgeous",List("Supple"),"long",List("black","chocolate","brown"),List("much","moderate","few"),List("greasy","general"),List("moderate","thin"),List("long-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--twenty-five","twenty-five--thirty-five"),"female",List("star"),date("2014-03-12"),true),
        Style(new ObjectId("530d828cd7f2861457761e0d"), "山间的美丽", new ObjectId("53202c29d4d5e3cd47efffd3"), List(new OnUsePicture(new ObjectId, "logo", Some(1), None)),"fresh",List("Supple"),"long",List("black","chocolate","brown"),List("much","moderate","few"),List("greasy","general"),List("bold","thin"),List("long-face","round-face","oval-face","diamond-face"),"此种发型清爽怡人，迎面而过，回眸一笑百媚生",List("one--fifteen","fifty-five--","one--twenty-five","twenty-five--thirty-five"),"female",List("star"),date("2014-03-12"),true),
        //男超短
