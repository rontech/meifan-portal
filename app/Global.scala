  ...
  def insertSampleData() {
   ...
   if(User.findAll.isEmpty){
      Seq(
       ...
       User(new ObjectId("53202c29d4d5e3cd47efffd6"),"demo07","陆小风","123456","F", date("1990-03-18"),Address("江苏省", Option("苏州市"), Option("高新区"), None, "竹园路209号", Some(100.0), Some(110.0)),new ObjectId,"15269845698","123@123.com",Seq(OptContactMethod("QQ", List{"845654891"})),"程序员","normal","userLevel.0",20,date("2014-03-18"),"LoggedIn", true),
