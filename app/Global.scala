...
//    }    
  ...
  def insertSampleData() {
    ...
    if(Salon.findAll.isEmpty) { 
      Seq(
        Salon(new ObjectId("530d7288d7f2861457771bdd"), SalonAccount("salon01", "123456"), "悦美月容吧", Some("悦容吧"), List("Hairdressing"), Some("www.sohu.com"), Some("本地最红的美发沙龙！"), PicDescription("国家的最先进的从银座发型始发！你把它设置为[] AFLOATJAPAN如果头发爱莫特！","实行开放银座[AFLOAT日本]！超人气沙龙AFLOAT人才，艺人以及参加许多，聚集人气造型师谁冠美容行业★意义上的顶级制作“永远的成年女性”可爱“，”中应该让我一定会满意你的技术。它的舒适放松的质量好平静的空间，这也是私人房间也很高兴☆","欢迎光临！"),"051268320328", "鸣人", List(OptContactMethod("QQ",List("99198121"))), date("2014-03-12"), Address("江苏省", Option("苏州市"), Option("高新区"), None, "竹园路209号", Some(100.0), Some(110.0),"地铁一号线汾湖路站1号出口向西步行500米可达") , WorkTime("9:00", "18:00"), List(RestDay(0,List(2))), 25, SalonFacilities(true, true, false, false, true, true, true, true, true, "附近有"), List(new OnUsePicture(new ObjectId, "LOGO", Some(1), None),new OnUsePicture(new ObjectId,"Navigate",Some(1),None),new OnUsePicture(new ObjectId,"Navigate",Some(2),None),new OnUsePicture(new ObjectId,"Navigate",Some(3),None)), date("2014-01-12") ),
        Salon(new ObjectId("530d7292d7f2861457771bde"), SalonAccount("salon02", "123456"), "千美千寻吧", Some("美寻吧"), List("Hairdressing"), Some("www.163.com"), Some("本地第二红的美发沙龙！"),PicDescription("国家的最先进的从银座发型始发！你把它设置为[] AFLOATJAPAN如果头发爱莫特！","实行开放银座[AFLOAT日本]！超人气沙龙AFLOAT人才，艺人以及参加许多，聚集人气造型师谁冠美容行业★意义上的顶级制作“永远的成年女性”可爱“，”中应该让我一定会满意你的技术。它的舒适放松的质量好平静的空间，这也是私人房间也很高兴☆","欢迎光临！"), "051268320328", "路飞", List(OptContactMethod("QQ",List("99198121"))), date("2014-03-12"), Address("江苏省", Option("苏州市"), Option("高新区"), None, "竹园路209号", Some(100.0), Some(110.0),"地铁一号线汾湖路站1号出口向西步行500米可达") , WorkTime("9:00", "18:00"), List(RestDay(0,List(1))), 9, SalonFacilities(true, true, true, true, false, true, true, true, true, "附近有"), List(new OnUsePicture(new ObjectId, "LOGO", None, None),new OnUsePicture(new ObjectId,"Navigate",Some(1),None),new OnUsePicture(new ObjectId,"Navigate",Some(2),None),new OnUsePicture(new ObjectId,"Navigate",Some(3),None)), date("2014-03-12") ),
        Salon(new ObjectId("530d7288d7f2861457771bdf"), SalonAccount("salon03", "123456"), "忆荣吧", Some("忆荣吧"), List("Hairdressing"), Some("www.sohu.com"), Some("本地最红的美发沙龙！"), PicDescription("国家的最先进的从银座发型始发！你把它设置为[] AFLOATJAPAN如果头发爱莫特！","实行开放银座[AFLOAT日本]！超人气沙龙AFLOAT人才，艺人以及参加许多，聚集人气造型师谁冠美容行业★意义上的顶级制作“永远的成年女性”可爱“，”中应该让我一定会满意你的技术。它的舒适放松的质量好平静的空间，这也是私人房间也很高兴☆","欢迎光临！"),"051268320328", "鸣人", List(OptContactMethod("QQ",List("99198121"))), date("2014-03-12"), Address("江苏省", Option("苏州市"), Option("高新区"), None, "竹园路209号", Some(100.0), Some(110.0),"地铁一号线汾湖路站1号出口向西步行500米可达") , WorkTime("9:00", "18:00"), List(RestDay(0,List(2))), 25, SalonFacilities(true, true, false, false, true, true, true, true, true, "附近有"), List(new OnUsePicture(new ObjectId, "LOGO", Some(1), None),new OnUsePicture(new ObjectId,"Navigate",Some(1),None),new OnUsePicture(new ObjectId,"Navigate",Some(2),None),new OnUsePicture(new ObjectId,"Navigate",Some(3),None)), date("2014-01-12") ),
        Salon(new ObjectId("530d7292d7f2861457771aaa"), SalonAccount("salon04", "123456"), "虞美人", Some("虞美人"), List("Hairdressing"), Some("www.163.com"), Some("本地第二红的美发沙龙！"),PicDescription("国家的最先进的从银座发型始发！你把它设置为[] AFLOATJAPAN如果头发爱莫特！","实行开放银座[AFLOAT日本]！超人气沙龙AFLOAT人才，艺人以及参加许多，聚集人气造型师谁冠美容行业★意义上的顶级制作“永远的成年女性”可爱“，”中应该让我一定会满意你的技术。它的舒适放松的质量好平静的空间，这也是私人房间也很高兴☆","欢迎光临！"), "051268320328", "路飞", List(OptContactMethod("QQ",List("99198121"))), date("2014-03-12"), Address("江苏省", Option("苏州市"), Option("高新区"), None, "竹园路209号", Some(100.0), Some(110.0),"地铁一号线汾湖路站1号出口向西步行500米可达") , WorkTime("9:00", "18:00"), List(RestDay(0,List(1))), 9, SalonFacilities(true, true, true, true, false, true, true, true, true, "附近有"), List(new OnUsePicture(new ObjectId, "LOGO", None, None),new OnUsePicture(new ObjectId,"Navigate",Some(1),None),new OnUsePicture(new ObjectId,"Navigate",Some(2),None),new OnUsePicture(new ObjectId,"Navigate",Some(3),None)), date("2014-03-12") ),
        Salon(new ObjectId("530d7292d7f2861457771bbb"), SalonAccount("salon05", "123456"), "美吧", Some("美吧"), List("Hairdressing"), Some("www.163.com"), Some("本地第二红的美发沙龙！"),PicDescription("国家的最先进的从银座发型始发！你把它设置为[] AFLOATJAPAN如果头发爱莫特！","实行开放银座[AFLOAT日本]！超人气沙龙AFLOAT人才，艺人以及参加许多，聚集人气造型师谁冠美容行业★意义上的顶级制作“永远的成年女性”可爱“，”中应该让我一定会满意你的技术。它的舒适放松的质量好平静的空间，这也是私人房间也很高兴☆","欢迎光临！"), "051268320328", "路飞", List(OptContactMethod("QQ",List("99198121"))), date("2014-03-12"), Address("江苏省", Option("苏州市"), Option("高新区"), None, "竹园路209号", Some(100.0), Some(110.0),"地铁一号线汾湖路站1号出口向西步行500米可达") , WorkTime("9:00", "18:00"), List(RestDay(0,List(1))), 9, SalonFacilities(true, true, true, true, false, true, true, true, true, "附近有"), List(new OnUsePicture(new ObjectId, "LOGO", None, None),new OnUsePicture(new ObjectId,"Navigate",Some(1),None),new OnUsePicture(new ObjectId,"Navigate",Some(2),None),new OnUsePicture(new ObjectId,"Navigate",Some(3),None)), date("2014-03-12") )
     ).foreach(Salon.save)
    }
