  ...
  def insertSampleData() {
    ...
    if (Stylist.findAll.isEmpty) {
      Seq(
        ...
        Stylist(new ObjectId, new ObjectId("53202c29d4d5e3cd47efffd4"), 5, List(new IndustryAndPosition(new ObjectId, "Stylist", "Manicures")), List("intellectual"), List("brief"), List("Supple", "setColor", "Care"), List("male", "female"), List("1~10", "10~20", "20~30", "30~40"), "先了解发型的形,在做发型的型。 先求稳,再求准,最后求快。 先看上下,再看左右,最后看手位。", "按照头皮通过样式建议☆脑袋矿泉根据（季节）的麻烦的建议,一个健康的状态样式建议☆日本四季可再生按照客户的后顾之忧,即使从后面的房子,改善☆（头按摩）", "*（自主开发,本作的,运动员都特别喜欢）（印象系统,人类系统特别喜欢）阅读*电影DVD观看是一个（*易清洁,整齐*厨师,健康食物卡在）", "建议适合女性的身材和喜好的麻烦,希望每一位客户,下一次不只是这一次,它建的故事,包括发型到下一个,但一☆砍你强​​调“易用性对待”,风格建议♪", (List(new OnUsePicture(new ObjectId, "logo", Some(1), None))), true, true),
        Stylist(new ObjectId, new ObjectId("53202c29d4d5e3cd47efffd9"), 5, List(new IndustryAndPosition(new ObjectId, "AdvancedStylist", "Manicures")), List("sweet"), List("star"), List("Perm", "Dye", "Care"), List("male", "female"), List("1~10", "10~20", "20~30", "30~40"), "☆剪发：宁长勿短,宁厚勿薄,宁低勿高。 ", "按照头皮通过样式建议☆脑袋矿泉根据（季节）的麻烦的建议,一个健康的状态样式建议☆日本四季可再生按照客户的后顾之忧,即使从后面的房子,改善☆（头按摩）", "*（自主开发,本作的,运动员都特别喜欢）（印象系统,人类系统特别喜欢）阅读*电影DVD观看是一个（*易清洁,整齐*厨师,健康食物卡在）", "建议适合女性的身材和喜好的麻烦,希望每一位客户,下一次不只是这一次,它建的故事,包括发型到下一个,但一☆砍你强​​调“易用性对待”,风格建议♪", (List(new OnUsePicture(new ObjectId, "logo", Some(1), None))), true, true),
        Stylist(new ObjectId, new ObjectId("53202c29d4d5e3cd47efffd8"), 5, List(new IndustryAndPosition(new ObjectId, "Assistant", "Healthcare")), List("fashion"), List("street"), List("Perm", "Supple", "Wash"), List("male", "female"), List("1~10", "10~20", "20~30", "30~40"), "☆烫发：卷度宁小勿大,卷芯选择/宁小勿大。", "按照头皮通过样式建议☆脑袋矿泉根据（季节）的麻烦的建议,一个健康的状态样式建议☆日本四季可再生按照客户的后顾之忧,即使从后面的房子,改善☆（头按摩）", "*（自主开发,本作的,运动员都特别喜欢）（印象系统,人类系统特别喜欢）阅读*电影DVD观看是一个（*易清洁,整齐*厨师,健康食物卡在）", "建议适合女性的身材和喜好的麻烦,希望每一位客户,下一次不只是这一次,它建的故事,包括发型到下一个,但一☆砍你强​​调“易用性对待”,风格建议♪", (List(new OnUsePicture(new ObjectId, "logo", Some(1), None))), true, true),
        Stylist(new ObjectId, new ObjectId("53202c29d4d5e3cd47efffd7"), 5, List(new IndustryAndPosition(new ObjectId, "Assistant", "Healthcare")), List("fashion"), List("street"), List("Blow", "Care", "Perm"), List("male", "female"), List("1~10", "10~20", "20~30", "30~40"), "☆染发：色度/宁深一度,不浅半度。色调/宁暗勿亮。", "按照头皮通过样式建议☆脑袋矿泉根据（季节）的麻烦的建议,一个健康的状态样式建议☆日本四季可再生按照客户的后顾之忧,即使从后面的房子,改善☆（头按摩）", "*（自主开发,本作的,运动员都特别喜欢）（印象系统,人类系统特别喜欢）阅读*电影DVD观看是一个（*易清洁,整齐*厨师,健康食物卡在）", "建议适合女性的身材和喜好的麻烦,希望每一位客户,下一次不只是这一次,它建的故事,包括发型到下一个,但一☆砍你强​​调“易用性对待”,风格建议♪", (List(new OnUsePicture(new ObjectId, "logo", Some(1), None))), true, true),
        Stylist(new ObjectId, new ObjectId("53202c29d4d5e3cd47efffd6"), 5, List(new IndustryAndPosition(new ObjectId, "Stylist", "Cosmetic")), List("fresh"), List("T-stage"), List("Cut", "Wash", "Care"), List("male", "female"), List("1~10", "10~20", "20~30", "30~40"), "☆美发师的成长经历 =模仿 + 吸收 +发挥。", "按照头皮通过样式建议☆脑袋矿泉根据（季节）的麻烦的建议,一个健康的状态样式建议☆日本四季可再生按照客户的后顾之忧,即使从后面的房子,改善☆（头按摩）", "*（自主开发,本作的,运动员都特别喜欢）（印象系统,人类系统特别喜欢）阅读*电影DVD观看是一个（*易清洁,整齐*厨师,健康食物卡在）", "建议适合女性的身材和喜好的麻烦,希望每一位客户,下一次不只是这一次,它建的故事,包括发型到下一个,但一☆砍你强​​调“易用性对待”,风格建议♪", (List(new OnUsePicture(new ObjectId, "logo", Some(1), None))), true, true),
        Stylist(new ObjectId, new ObjectId("53202c29d4d5e3cd47efffd5"), 5, List(new IndustryAndPosition(new ObjectId, "Stylist", "Cosmetic")), List("personality"), List("T-stage"), List("Blow", "Dye", "Wash"), List("male", "female"), List("1~10", "10~20", "20~30", "30~40"), "苦和甜来自于外界,而坚强则来自内心,来自于一个人坚持不懈的努力！", "按照头皮通过样式建议☆脑袋矿泉根据（季节）的麻烦的建议,一个健康的状态样式建议☆日本四季可再生按照客户的后顾之忧,即使从后面的房子,改善☆（头按摩）", "*（自主开发,本作的,运动员都特别喜欢）（印象系统,人类系统特别喜欢）阅读*电影DVD观看是一个（*易清洁,整齐*厨师,健康食物卡在）", "建议适合女性的身材和喜好的麻烦,希望每一位客户,下一次不只是这一次,它建的故事,包括发型到下一个,但一☆砍你强​​调“易用性对待”,风格建议♪", (List(new OnUsePicture(new ObjectId, "logo", Some(1), None))), true, true),
    ...
    if (Style.findAll.isEmpty) {
      Seq(
        ...
        //女长
        Style(new ObjectId("533151209aa6b4dfc54a0478"), "波浪长发", new ObjectId("53202c29d4d5e3cd47efffd6"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "personality", List("Supple", "Perm"), "long", List("chocolate", "brown", "flax", "red"), List("much"), List("silky", "greasy", "general"), List("bold", "thin", "moderate"), List("round-face", "oval-face", "diamond-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--twenty-five", "twenty-five--thirty-five"), "female", List("star", "street", "evening-wear"), date("2014-03-12"), true),
        Style(new ObjectId("533151209aa6b4dfc54a0479"), "可爱梨花头", new ObjectId("53202c29d4d5e3cd47efffd6"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "natural", List("Supple"), "long", List("chocolate", "brown", "flax", "red"), List("much"), List("silky", "greasy", "general"), List("bold"), List("oval-face", "diamond-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--twenty-five", "twenty-five--thirty-five"), "female", List("star", "evening-wear", "others"), date("2014-03-12"), true),
        Style(new ObjectId("533151209aa6b4dfc54a0473"), "妩媚大长发", new ObjectId("53202c29d4d5e3cd47efffd5"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "personality", List("Supple", "Perm"), "long", List("chocolate", "brown", "flax", "red"), List("much"), List("silky", "greasy", "general"), List("bold"), List("long-face", "round-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--twenty-five", "twenty-five--thirty-five"), "female", List("star"), date("2014-03-12"), true),
        Style(new ObjectId("530d828cd7f2861457761e0b"), "过肩大长发", new ObjectId("530d8010d7f2861457771bf8"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "fresh", List("Supple"), "long", List("black", "chocolate", "brown", "flax", "red", "alternative"), List("much", "moderate", "few"), List("greasy", "general"), List("bold", "thin"), List("round-face", "diamond-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--twenty-five", "twenty-five--thirty-five"), "female", List("star"), date("2014-03-12"), true),
        Style(new ObjectId("530d828cd7f2861457762e0c"), "过肩长卷发", new ObjectId("53202c29d4d5e3cd47effff2"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "gorgeous", List("Supple"), "long", List("black", "chocolate", "brown"), List("much", "moderate", "few"), List("greasy", "general"), List("moderate", "thin"), List("long-face", "diamond-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--twenty-five", "twenty-five--thirty-five"), "female", List("star"), date("2014-03-12"), true),
        Style(new ObjectId("530d828cd7f2861457761e0d"), "山间的美丽", new ObjectId("53202c29d4d5e3cd47efffd3"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "fresh", List("Supple"), "long", List("black", "chocolate", "brown"), List("much", "moderate", "few"), List("greasy", "general"), List("bold", "thin"), List("long-face", "round-face", "oval-face", "diamond-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--fifteen", "fifty-five--", "one--twenty-five", "twenty-five--thirty-five"), "female", List("star"), date("2014-03-12"), true),
        //男超短
        ...
        Style(new ObjectId("533151209aa6b4dfc54a1397"), "青春卷发", new ObjectId("53202c29d4d5e3cd47efffd5"), List(new OnUsePicture(new ObjectId, "main", Some(1), None), new OnUsePicture(new ObjectId, "side", Some(1), None), new OnUsePicture(new ObjectId, "back", Some(1), None)), "sweet", List("Supple", "Perm"), "short", List("chocolate", "brown", "flax", "red"), List("much"), List("silky", "greasy", "dry", "general"), List("bold", "thin"), List("long-face", "oval-face"), "此种发型清爽怡人,迎面而过,回眸一笑百媚生", List("one--twenty-five", "twenty-five--thirty-five"), "male", List("star", "street", "others"), date("2014-03-12"), true),
        //男及肩
    ...
    if (Coupon.findAll.isEmpty) {
      Seq(
        ...
        Coupon(new ObjectId("5317c0d1d4d57997ce2e6ee8"), "xjc14", "适合约会美发组合", new ObjectId("530d7288d7f2861457771aad"), List(Service(new ObjectId("5316c048d4d57997ce3e6d5a"), "简洗", "简单清洗", "Wash", new ObjectId("530d7288d7f2861457771bdd"), 10, 10, date("2014-03-31"), null, true), Service(new ObjectId("5316bb51d4d57997ce3e6d4b"), "局部染", "对发梢进行染色或者挑染", "Dye", new ObjectId("530d7288d7f2861457771bdd"), 90, 120, date("2014-03-31"), null, true), Service(new ObjectId("5316bb36d4d57997ce3e6d49"), "离子烫", "离子烫对头发保护性最强", "Perm", new ObjectId("530d7288d7f2861457771bdd"), 90, 100, date("2014-03-31"), null, true)), 230, 190, 120, date("2014-03-01"), date("2015-01-31"), "你看到的HOTPEPPER美容♪字", "在预订时间", "仅售120元！最高价值1338元的白领美发美甲沙龙美发套餐，不限男女，不限长短发，店内提供免费WiFi。", true)).foreach(Coupon.save)
    }
    ...
    if (Service.findAll.isEmpty) {
      Seq(
        ...
        Service(new ObjectId("53168b38d4d5cb7e816db44c"), "剪刘海", "专门剪刘海", "Cut", new ObjectId("530d7292d7f2861457771bbb"), 10, 10, date("2014-03-31"), null, true)).foreach(Service.save)
    }
    ...
    if (Comment.findAll.isEmpty) {
      Seq(
        ...
        Comment(new ObjectId, 2, new ObjectId("5317c0d1d4d57997ce3e6d6b"), "这家店是我有史以来去过的最好的一家店,强力推荐大家一起去。", 5, 5, 5, 5, 5, "demo07", date("2014-04-01"), true)).foreach(Comment.save)
    }
...
<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: &#39;Microsoft YaHei&#39;, Arial, Helvetica, &#39;MS PGothic&#39;, sans-serif; font-size: 12px; line-height: 18px; white-space: normal;">
    ...
    if (Reservation.findAll.isEmpty) {
      Seq(
        ...
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("530d8010d7f2861457771bf8")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533133f29aa6b4dfc54a023d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("530d8010d7f2861457771bf8")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533133f29aa6b4dfc54a023d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        ...
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd6")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("530d828cd7f2861457771c0d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd4")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533133f29aa6b4dfc54a02ed")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47effff2")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533134b69aa6b4dfc54a02ee")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd3")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533133f29aa6b4dfc54a021d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd9")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533134b69aa6b4dfc54a021e")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("530d8010d7f2861457771bf8")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533133f29aa6b4dfc54a023d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd7")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533134b69aa6b4dfc54a023e")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd4")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533134db9aa6b4dfc54a02ef")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47effff2")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a0374")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd5")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533134db9aa6b4dfc54a022f")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd9")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a0324")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd8")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533133f29aa6b4dfc54a022d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        ...
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd6")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a0378")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd9")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a0379")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd5")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a0373")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("530d8010d7f2861457771bf8")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("530d828cd7f2861457761c0b")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd4")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("530d828cd7f2861457762c0c")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdd"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47effff2")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("530d828cd7f2861457761c0d")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        ...
        Reservation(new ObjectId, "demo08", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd7")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1395")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7292d7f2861457771bde"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("530d8010d7f2861457771bf8")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1396")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd5")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1397")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd7")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1575")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7292d7f2861457771bde"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd9")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1576")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47effff2")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1577")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd7")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1675")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo07", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd3")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1676")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        ...
        Reservation(new ObjectId, "demo08", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd3")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1776")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo09", new ObjectId("530d7292d7f2861457771bde"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47effff2")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1777")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-11 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47efffd5")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1875")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        ...
        Reservation(new ObjectId, "demo10", new ObjectId("530d7288d7f2861457771bdf"), 1, dateTime("2014-04-12 10:00"), 90, Option(new ObjectId("53202c29d4d5e3cd47effff2")), List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), Option(new ObjectId("533151209aa6b4dfc54a1877")), "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11"))).foreach(Reservation.save)
    }
