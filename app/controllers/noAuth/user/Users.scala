    ...
    mapping(
      ...
      "optContactMethods" -> seq(
        mapping(
          ...
          User(new ObjectId, userId, nickName, BCrypt.hashpw(password._1, BCrypt.gensalt()), "M", None, None, new ObjectId,None, email, optContactMethods, None, User.NORMAL_USER,  User.HIGH, 20, 0, new Date(), Permission.valueOf(LoggedIn), false)
      } {
